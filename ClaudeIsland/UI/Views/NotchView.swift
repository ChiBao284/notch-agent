...
struct NotchView: View {
    ...
    ///
    /// Stays true for as long as the session itself is in that phase — no
    /// timer, no "seen it" bookkeeping. It only goes away when the session
    /// starts a new turn or ends.
